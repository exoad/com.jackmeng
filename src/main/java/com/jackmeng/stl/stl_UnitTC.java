        ...
        Runnable
{
        ...
        public stl_UnitTC(String name, stl_Callback< Object, ? > action, Object expect)
        {
                this(name, action);
                this.expects = expect;
        }
        ...
        @Override public void run()
        {
                ...
                } catch (Exception e)
                {
                        System.out.println(
                                        new stl_AnsiMake(
                                                        new stl_AnsiColors[] { stl_AnsiColors.GREEN_BG,
                                                                        stl_AnsiColors.BLACK_TXT },
                ...
                System.out.println("Finished in: " + t + "ms\nMemory used: "
                                ...
                                + (expects == null ? "\nCase Status: " + new stl_AnsiMake(
                                                new stl_AnsiColors[] { stl_AnsiColors.BLUE_BG,
                                                                stl_AnsiColors.BLACK_TXT },
                                                new Object[] { "NONE" })
                                                : "\nCase status: " + ((returns.equals(expects)
                                                                ? new stl_AnsiMake(
                                                                                new stl_AnsiColors[] {
                                                                                                stl_AnsiColors.GREEN_BG,
                                                                                                stl_AnsiColors.BLACK_TXT },
                                                                                new Object[] { "PASSED" })
                                                                : new stl_AnsiMake(
                                                                                new stl_AnsiColors[] {
                                                                                                stl_AnsiColors.RED_BG,
                                                                                                stl_AnsiColors.BLACK_TXT },
                                                                                new Object[] { "FAILED" }))
                                                                + "\nExpected: " + expects + "\nReturned: "
                                                                + returns)));
